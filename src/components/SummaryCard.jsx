...
const SummaryCard = ({totalIncome, totalExpenses, balance}) => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-12'>
        <div className='bg-linear-to-r from-emerald-500/10 to bg-emerald-600/10 backdrop-blur-sm rounded-3xl p-8 border border-emerald-500/20 shadow-xl'>
        ...
        <div className='bg-linear-to-r from-red-500/10 to bg-red-600/10 backdrop-blur-sm rounded-3xl p-8 border border-red-500/20 shadow-xl'>
        <div className='flex items-center justify-between'>
            <div>
        ...
        {/* I'll use logic to render the  conditional */}
        ...
        <div className='flex items-center justify-between'>
            ...
            <div className={`${
                balance >= 0 ? "bg-blue-500/20" : "bg-orange-500/20"} p-4 rounded-2xl`}>
              <DollarSign className={`${
                balance >= 0 ? "text-blue" : "text-orange-400"
              } w-8 h-8`} />
            </div>
